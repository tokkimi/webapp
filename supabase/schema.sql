...
CREATE TABLE IF NOT EXISTS public.profiles (
  ...
  name          text,
  email         text,
  profile_type  text CHECK (profile_type IN ('ado', 'jeune', 'parent', 'pro', 'admin', 'superadmin')) NOT NULL DEFAULT 'ado',
  birth_date    date,
  avatar_url    text,
  bio           text,
  specialty     text,
...
CREATE TABLE IF NOT EXISTS public.newsletter_subscribers (
  ...
  name           text,
  profile_type   text CHECK (profile_type IN ('ado', 'jeune', 'parent', 'pro', 'admin', 'superadmin')),
